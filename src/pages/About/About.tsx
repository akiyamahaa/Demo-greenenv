...
const About = () => {
  return (
    <Box className="about">
      ...
      <Stack className="about--images" flexDirection={"row"} alignItems={"center"} gap={2}>
        <Box flex={1}>
          <img src={img1} alt="person collecting litter" style={{width: "100%"}}/>
        </Box>
        <Box flex={1}>
          <img src={img2} alt="people determined in teamworking" style={{width: "100%"}}/>
        </Box>
        <Box flex={1}>
          <img src={img3} alt="people collecting trash"style={{width: "100%"}}/>
        </Box>
      </Stack>
      <Grid className="about--text_container">
